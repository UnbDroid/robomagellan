...
(cl:defmethod cl:initialize-instance :after ((m <StampedInt8>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedInt8)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arduino_msgs-msg:<StampedInt8> is deprecated: use arduino_msgs-msg:StampedInt8 instead.")))
