...
(cl:defmethod cl:initialize-instance :after ((m <StampedBool>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedBool)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arduino_msgs-msg:<StampedBool> is deprecated: use arduino_msgs-msg:StampedBool instead.")))
