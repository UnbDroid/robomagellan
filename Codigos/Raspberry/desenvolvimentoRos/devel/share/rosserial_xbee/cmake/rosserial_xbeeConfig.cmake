...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/pi/Documents/desenvolvimentoRos/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/pi/Documents/desenvolvimentoRos/devel)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/pi/Documents/desenvolvimentoRos/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/Documents/desenvolvimentoRos/src/rosserial/rosserial_xbee/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>' to fix it.")
    endif()
