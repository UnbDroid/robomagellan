...
(cl:in-package bruce_vision-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bruce_vision-msg:<Num> is deprecated: use bruce_vision-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bruce_vision-msg:num-val is deprecated.  Use bruce_vision-msg:num instead.")
  (num m))
