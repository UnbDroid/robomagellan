...
(cl:defmethod cl:initialize-instance :after ((m <StampedString>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedString)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arduino_msgs-msg:<StampedString> is deprecated: use arduino_msgs-msg:StampedString instead.")))
