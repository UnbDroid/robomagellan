...
(cl:defmethod cl:initialize-instance :after ((m <StampedChar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedChar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arduino_msgs-msg:<StampedChar> is deprecated: use arduino_msgs-msg:StampedChar instead.")))
