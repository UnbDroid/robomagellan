...
(cl:defmethod cl:initialize-instance :after ((m <StampedFloat64>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedFloat64)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspberry_msgs-msg:<StampedFloat64> is deprecated: use raspberry_msgs-msg:StampedFloat64 instead.")))
