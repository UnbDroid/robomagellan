...
(cl:defmethod cl:initialize-instance :after ((m <StampedUint32>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedUint32)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspberry_msgs-msg:<StampedUint32> is deprecated: use raspberry_msgs-msg:StampedUint32 instead.")))
