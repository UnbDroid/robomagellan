...
(cl:defmethod cl:initialize-instance :after ((m <StampedInt64>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedInt64)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspberry_msgs-msg:<StampedInt64> is deprecated: use raspberry_msgs-msg:StampedInt64 instead.")))
