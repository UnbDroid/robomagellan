...
(cl:defmethod cl:initialize-instance :after ((m <StampedFloat32>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedFloat32)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspberry_msgs-msg:<StampedFloat32> is deprecated: use raspberry_msgs-msg:StampedFloat32 instead.")))
